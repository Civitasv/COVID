...
public class VirusController {
    ...
    @GetMapping("/china")
    public String getAllChinaVirus() {
        List<HashMap<String, Object>> list = service.getAllChinaVirus();
        // 组装GeoJSON数据
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("type", "FeatureCollection");
        JSONArray jsonArray = new JSONArray();
     ...
     * @return json数据
     */
    @GetMapping("/china/day")
    public String getChinaVirusDivideByTime() {
        List<HashMap<String, Integer>> list = service.getChinaVirusDivideByTime();
        // 解析excel时间
        JSONArray jsonArray = new JSONArray(list);
     ...
     * @return json数据
     */
    @GetMapping("/china/dayAdded")
    public String getAllChinaVirusDivideByTime() {
        List<HashMap<String, Integer>> list = service.getChinaVirusDivideByTime();
        // 解析excel时间
        JSONArray jsonArray = new JSONArray(list);
        int confirmed = 0;
